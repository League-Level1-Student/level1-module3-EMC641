 ...
 * 1. Run the program and move the sliders.    DONE
 ...
 *    variables in the Circle class in this package   DONE
 * 
 * 3. Run the program again and move the sliders.
 *    Notice that changing the radius or color of one of the sliders now
 *    affects all of the circles.   DONE
 * 
 *    This is because adding static makes the variable apply for each object    DONE
 ...
 * 
 * Lifetime of member variables vs. class variables   DONE
 ...
 * 
 * 5. Run the program. The console should print out:  DONE
 *      circle radius = 0
 *      circle color = null
 * 
 * 6. In the Circle class, remove the static keyword from the radius and color   dONE
 *    variables.
 ...
 *    object is created.
 * 
 * 7. Move the prints below the code that makes the Circle objects and change:   DONE
 *    Circle.radius to circle1.radius
 *    Circle.color to circle1.color
 * 
 * 8. Run the program. The console should print the radius and color of just   DONE
 *    ONE of the circles. A variable without static (member variable) only
 *    exists AFTER the circle object is created.
 * 
 * Mixing static and non-static methods   DONE
 ...
 * 
 * 10.Add static to the beginning of the canvas variable at the beginning of  DONE
